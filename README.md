...
Desarrolla una API que dé permita implementar los siguientes requisitos funcionales:

Se desea desarrollar una app para realizar cursos online.
Para ello se debe poder hacer lo siguiente:
...
API desarrollada utilizando LARAVEL
